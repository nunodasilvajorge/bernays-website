...
const features = [
  ...
  },
  {
    ...
    body: "Retainers configurados uma vez, emitidos sempre. P&L por cliente, cobranças visíveis, cashflow actualizado. Sem surpresas no final do mês.",
  ...
  },
  {
    ...
    body: "Tarefas, alertas financeiros e horas num painel pessoal. Cada consultor sabe exactamente o que fazer — sem perguntar ao gestor.",
