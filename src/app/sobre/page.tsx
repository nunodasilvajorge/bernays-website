      ...
      <div className="max-w-5xl mx-auto px-6 pt-32 pb-24">
        ...
        <div className="max-w-3xl mx-auto space-y-16">
          ...
          <FadeIn>
            <div className="grid md:grid-cols-[auto_1fr] gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-[13px] font-semibold text-brand mb-4 tracking-wide">
          ...
          <FadeIn delay={0.05}>
            <div>
              <p
                className="text-sm font-semibold text-brand tracking-widest uppercase mb-5"
              >
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0 40px oklch(0.581 0.243 263 / 0.05)",
                }}
              >
                ...
                <div className="space-y-2.5 border-t pt-5" style={{ borderColor: "var(--page-border)" }}>
                  {[
                    "Boas práticas de PR integradas de origem no produto",
                    "Fluxos de trabalho reais de agência — não adaptados de outro sector",
                    "Investigação aplicada à criação de valor em comunicação estratégica",
                  ].map((item) => (
                ...
                <div className="mt-5 pt-5 border-t" style={{ borderColor: "var(--page-border)" }}>
                  <a
          ...
          <FadeIn delay={0.05}>
            <div>
              ...
              <p className="text-[15px] leading-[1.8] mb-4" style={{ color: "var(--page-text-muted)" }}>
              ...
              <p className="text-[15px] leading-[1.8]" style={{ color: "var(--page-text-muted)" }}>
          ...
          <FadeIn delay={0.05}>
            <div
              className="relative -mx-6 px-8 py-12 rounded-2xl overflow-hidden border-y"
          ...
          {/* CTA */}
          <FadeIn delay={0.05}>
            <div className="border-t pt-8 flex flex-col sm:flex-row gap-4" style={{ borderColor: "var(--page-border)" }}>
              <a
                href={DEMO_URL}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 font-semibold px-8 py-3.5 rounded-xl text-[15px] border transition-colors duration-150 hover:border-brand/40"
